...
pattern([1, 2, X, has, advantage, over, T], ['\n', yes, X, 'has advantage over', T]) :-
    advantage(X, T).
...
pattern([1, type, X, has, advantage, over, Y], ['\n', yes, X, 'has advantage over', Y]) :-
    strong(X, Y).
...
pattern([what, is, X, imunne, against], ['\n', X, 'is imunne against', Elem1]) :-
