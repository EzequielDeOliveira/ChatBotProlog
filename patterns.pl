...
pattern([X, is, 1, pokemon, ?], [yes, X, is, a, 'pokemon -', Y]) :-
    pokemon(X, Y).

%% Padrões do tipo do pokemon
% Quando o pokemon tem 1 tipo
pattern([what, X, type], [X, type, is, Elem]) :-
    getPokemonType(X, Elem).
%Quando o pokemon tem 2 tipos
pattern([what, X, type], [X, type, is, Elem, and, Elem2]) :-
...
pattern([what, 1, X, evolution], [X, evolution, is, Elem]) :-
    getPokemonEvolution(X, Elem).
pattern([what, 1, X, evolutions], [X, evolution, are, Elem, and, Elem2]) :-
    getPokemonEvolution(X, Elem, Elem2).

%Padrões de desevolução do pokemon
pattern([what, 1, X, previous, evolution], [X, previous, evolution, is, Elem]) :-
    getPokemonPreviousEvolution(X, Elem).
pattern([what, 1, X, previous, evolutions], [X, previous, evolution, are, Elem, and, Elem2]) :-
...
pattern([1, 2, X, has, advantage, over, T], [yes, X, 'has advantage over', T]) :-
    advantage(X, T).

pattern([1, 2, X, has, advantage, over, T], [no, X, 'has disadvantage over', T]) :-
    disadvantage(X, T).


%Padrões de vantagem entre tipos
pattern([1, type, X, has, advantage, over, Y], [yes, X, 'has advantage over', Y]) :-
    strong(X, Y).

pattern([1, type, X, has, advantage, over, Y], [no, X, 'has disadvantage over', Y]) :-
    weak(X, Y).


%Padrões de listagem de fraquezas de um pokemon
pattern([what, are, X, weaknesses], FinalBag) :-
    getPokemonMultipleWeakness(X, FinalBag).

pattern([what, are, X, weaknesses], [X, weakness, are, Elem1, and, Elem2]) :-
    getPokemonWeakness(X, Elem1, Elem2).

pattern([what, are, X, weaknesses], [X, weakness, are, Elem1, ',', Elem2, and, Elem3]) :-
    getPokemonWeakness(X, Elem1, Elem2, Elem3).

pattern([what, are, X, weaknesses], [X, weakness, are, Elem1, ',', Elem2, ',', Elem3, and, Elem4]) :-
    getPokemonWeakness(X, Elem1, Elem2, Elem3, Elem4).

pattern([what, are, X, weaknesses], [X, weakness, are, Elem1, ',', Elem2, ',', Elem3, ',', Elem4, and, Elem5]) :-
...
pattern([what, is, X, strong, against], FinalBag) :-
    getPokemonMultipleStrongness(X, FinalBag).

pattern([what, is, X, strong, against], [X, 'is strong against', Elem1, and, Elem2]) :-
    getPokemonStrongness(X, Elem1, Elem2).

pattern([what, is, X, strong, against], [X, 'is strong against', Elem1, ',', Elem2, and, Elem3]) :-
    getPokemonStrongness(X, Elem1, Elem2, Elem3).

pattern([what, is, X, strong, against], [X, 'is strong against', Elem1, ',', Elem2, ',', Elem3, and, Elem4]) :-
    getPokemonStrongness(X, Elem1, Elem2, Elem3, Elem4).

pattern([what, is, X, strong, against], [X, 'is strong against', Elem1, ',', Elem2, ',', Elem3, ',', Elem4, and, Elem5]) :-
...
pattern([what, is, X, imunne, against], FinalBag) :-
    getPokemonMultipleImunnities(X, FinalBag).

pattern([what, is, X, imunne, against], [X, 'is imunne against', Elem1]) :-
    getPokemonImunities(X, Elem1).

pattern([what, is, X, imunne, against], [X, 'is imunne against', Elem1, and, Elem2]) :-
